...
Canonical **analytics-core** package for OpenLMIS/OLMIS, consumed by the [reporting-stack platform](https://github.com/SolDevelo/soldevelo-reporting-stack).

This package provides the Debezium connector config, dbt models/tests, and Superset assets for baseline OpenLMIS reporting. Adopters fork or extend it for their own deployments; the reference country extension lives in [mw-reporting](https://github.com/OpenLMIS-Malawi/mw-reporting).
...
See [the platform's docs/architecture.md](https://github.com/SolDevelo/soldevelo-reporting-stack/blob/main/docs/architecture.md#manifestyaml) for the full schema.
...
For detailed guidance on each step, see [the platform's docs/usage-guide.md](https://github.com/SolDevelo/soldevelo-reporting-stack/blob/main/docs/usage-guide.md).
